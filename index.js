(function() {
  ...
  function main() {
    ...
    var triangleVertices = new Float32Array([
        +0.05, -0.6,    0.5, 1.0, 0.5,
        0.0, -0.6,    0.2, 1.0, 0.4,
        0.0, +0.5,   0.3, 1.0, 0.6,

        0.0, +0.5,    0.1, 0.6, 0.9,
        +0.05, +0.5,   0.1, 0.6, 0.9,
        +0.05, -0.6,   0.1, 0.6, 0.9,

        +0.05, +0.4,    0.5, 1.0, 0.5,
        +0.05, +0.5,    0.2, 1.0, 0.4,
        +0.35, +0.5,    0.3, 1.0, 0.6,

        +0.05, +0.4,   0.1, 0.6, 0.9,
        +0.25, +0.4,   0.1, 0.6, 0.9,
        +0.35, +0.5,   0.1, 0.6, 0.9,


        +0.05, 0.0,   0.5, 1.0, 0.5,
        +0.05, +0.1,   0.2, 1.0, 0.4,
        +0.25, +0.1,   0.3, 1.0, 0.6,

        +0.05, +0.0,   0.1, 0.6, 0.9,
        +0.25, +0.0,   0.1, 0.6, 0.9,
        +0.25, 0.1,   0.1, 0.6, 0.9,
    ]);
